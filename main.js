...
const createWindow = () => {
  ...
  win.webContents.setWindowOpenHandler(({ url }) => {
    const parsedUrl = new URL(url);
    const isInternal = parsedUrl.hostname.endsWith('haxball.com') || parsedUrl.hostname.endsWith('hqxball.com');

    if (isInternal && url !== "https://haxball.com/playerauth" && url !== "https://hqxball.com/playerauth") {
      createWindow(url);
    } else {
      shell.openExternal(url);
    }
